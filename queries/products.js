...
const createProduct = async () => {
    try {
        const newProduct = await db.one( 
            ...
            [products.id, products.seller_id, products.name, products.image, products.cost, products.weight, products.unit_measurement, products.category, products.description, products.stock]
        );
        return newProduct;
    } catch (error) {
        return {error: error};
...
const updateProduct = async (id) => {
    try {
        const updatedProduct = await db.one (
            ...
            [products.seller_id, products.name, products.image, products.cost, products.weight, products.unit_measurement, products.category, products.description, products.stock, id]
        );
